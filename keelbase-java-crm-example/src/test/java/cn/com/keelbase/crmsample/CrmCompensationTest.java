...
/**
 * Reference Project 验收：create_followup_task 撤销走补偿端点（委托身份 + 幂等 + 审计）。
 */
@SpringBootTest
@AutoConfigureMockMvc
class CrmCompensationTest {
    ...
    @Test
    void revoke_followupTask_firstRevoked_thenIdempotent() throws Exception {
        var created = mvc.perform(post("/api/customers/1/followups")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"content\":\"回访确认合同细节\",\"dueDate\":\"2026-09-01\"}"))
